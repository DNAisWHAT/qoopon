    ...
    {    (async () => {
            ...
            while (flag) {
                try {
                    ...
                    await page.type('#recaptcha_response_field', resultText, {delay: 10});
                    ...
                    console.log(`${combo[0]} : maybe this gets strumbled or failed to pass captcha.`);
                }
            }



            // 여기서 시작하면 이제 로그인 다 된 상태임. OCR 기능만 추가하면 됨!
            //// login.js -> coupon_info.js -> coupon_OCR.js
